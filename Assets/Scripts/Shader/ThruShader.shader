Shader "Custom/ThruShader"
{
		...
		SubShader
	{
		...
		CBUFFER_END
		TEXTURE2D(Texture2D_A5DA835C); SAMPLER(samplerTexture2D_A5DA835C); float4 Texture2D_A5DA835C_TexelSize;
		SAMPLER(_SampleTexture2D_A12D83A_Sampler_3_Linear_Repeat);
		...
		SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
		{
			...
			float4 _SampleTexture2D_A12D83A_RGBA_0 = SAMPLE_TEXTURE2D(Texture2D_A5DA835C, samplerTexture2D_A5DA835C, IN.uv0.xy);
			float _SampleTexture2D_A12D83A_R_4 = _SampleTexture2D_A12D83A_RGBA_0.r;
			float _SampleTexture2D_A12D83A_G_5 = _SampleTexture2D_A12D83A_RGBA_0.g;
			float _SampleTexture2D_A12D83A_B_6 = _SampleTexture2D_A12D83A_RGBA_0.b;
			float _SampleTexture2D_A12D83A_A_7 = _SampleTexture2D_A12D83A_RGBA_0.a;
			surface.Albedo = (_SampleTexture2D_A12D83A_RGBA_0.xyz);
